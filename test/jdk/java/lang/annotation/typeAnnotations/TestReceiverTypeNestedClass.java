 ...
 * @test
 * @bug 8259224
 * @summary A receiver type is returned as the correct generic type for nested classes.
 */

import java.lang.reflect.AnnotatedParameterizedType;
import java.lang.reflect.AnnotatedType;

public class TestReceiverTypeNestedClass<T> {

    public static void main(String[] args) throws Exception {
        AnnotatedType nested = Class.forName(TestReceiverTypeNestedClass.class.getTypeName() + "$Nested").getMethod("method").getAnnotatedReceiverType();
    ...
    public class Nested {
        public void method(TestReceiverTypeNestedClass<T>.Nested this) { }
    }

    public static class Inner {
        public void method(TestReceiverTypeNestedClass.Inner this) { }
    }

    public static class GenericInner<S> {
        public void method(TestReceiverTypeNestedClass.GenericInner<S> this) { }
    }
}
